...
En las principales zonas acuícolas de la costa peruana, la actividad maricultura se desarrolla en condiciones variables donde el bioincrustamiento es agresivo y constante [[3]](#referencias). La falta de un monitoreo preciso de la condición física de la infraestructura dificulta tomar decisiones correctas en el manejo del cultivo.
